...
- The sharded `LargeRegionCache` now has fixed hot/cold exact-page indexes for the first 64 mapped pages, preserving exact hot/cold precedence and the existing best-fit fallback.
